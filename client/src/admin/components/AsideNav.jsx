                        ...
                        <ul className='absolute  flex flex-col gap-4 bottom-0 w-full my-5' >
                            ...
                            <li>
                                <div className="flex items-center gap-2 ">
                                    ...
                                    <div>
                                        <h3 className='font-bold text-xl'>{user?.usuario}</h3>
                            ...
                            <li>
                                <button onClick={logout} className='flex items-center bg-black text-white text-sm rounded-md p-3 w-full gap-2 justify-between px-4 ' >
                                    Cerrar Sesión
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
